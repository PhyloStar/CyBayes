...
parser.add_argument("-t0","--init_temp", help="Initial Temperature",  type=int)
...
if config.MODEL == "F81":
    ...
    weights = np.array([0.5, 5, 1, 0.5], dtype=np.float64)
...
print("Iter", "LnL", "TL", "Alpha", "Temperature", sep="\t", file=params_fileWriter)
