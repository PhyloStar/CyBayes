...
ext_modules=[ Extension("config", ["config.pyx"]), Extension("utils", ["utils.pyx"], include_dirs=[numpy.get_include()]), Extension("ML_gamma", ["ML_gamma.pyx"], libraries=["m"], extra_compile_args = ["-ffast-math"], include_dirs=[numpy.get_include()]), Extension("mcmc_gamma", ["mcmc_gamma.pyx"], libraries=["m"], extra_compile_args = ["-ffast-math"], include_dirs=[numpy.get_include()]), Extension("CyML", ["CyML.pyx"], libraries=["m"], extra_compile_args = ["-ffast-math"], include_dirs=[numpy.get_include()])])
